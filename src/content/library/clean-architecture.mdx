...
description: "Another Uncle Bob bible — the dependency rule alone earns it a place on the shelf, padding and all."
...
Another Uncle Bob bible. The dependency rule at its core is worth the price — the padding
around it is the cost of admission. Read it.
</Callout>
