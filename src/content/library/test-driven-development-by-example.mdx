...
description: "A key one to read and reread — the red-green-refactor loop crystallised in 240 pages."
...
<Callout type="tip" title="Verdict — Essential (my rating 5 · public 4.10)">
A key one to read and reread. Read it once to get the fundamentals; come back 1–2 years
later after real practice and you'll get a completely different layer of insight out of
the same pages. 5 stars.
</Callout>
