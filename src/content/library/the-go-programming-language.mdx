...
A good book to get the key concepts of Go. Carries the K&R lineage and earns it — the
fastest route from "Go compiles" to "Go reads right" for an engineer already fluent in
another language.
</Callout>
