...
Good but not as transformative as Beck's TDD book. Read it for the values and the
permission to drop ceremony — the specific practices are dated, the underlying argument
isn't. If you only read one Beck book, make it TDD by Example.
</Callout>
