...
description: "The first quarter is solid; after that it repeats itself more than it deepens."
...
<Callout type="tip" title="Verdict — Optional (my rating 3.0 · public 3.72)">
OK. The opening chapters on events-as-contracts are worth reading. After that it loses
momentum and starts repeating the same ideas with different examples. Read the first
quarter, skim the rest.
</Callout>
