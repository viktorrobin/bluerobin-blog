...
- [n8n Official Documentation](https://docs.n8n.io/) -- Comprehensive guides on nodes, triggers, and self-hosting.
- [Flux CD Documentation](https://fluxcd.io/flux/) -- GitOps toolkit for managing Helm releases on Kubernetes.
- [Kubernetes Patterns by Bilgin Ibryam and Roland Hub](https://www.oreilly.com/library/view/kubernetes-patterns-2nd/9781098131678/) -- Design patterns for containerized applications, including sidecar and ambassador patterns relevant to n8n deployment.
