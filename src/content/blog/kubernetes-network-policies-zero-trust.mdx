...
- [NIST SP 800-207: Zero Trust Architecture](https://csrc.nist.gov/publications/detail/sp/800-207/final) -- The authoritative framework for zero-trust design principles.
- [Cilium Documentation](https://docs.cilium.io/) -- Comprehensive guide to Cilium's eBPF-powered networking and security.
- [Kubernetes Security Best Practices](https://kubernetes.io/docs/concepts/security/) -- Official guidance on securing Kubernetes workloads.
