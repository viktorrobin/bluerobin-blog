...
- [Call JavaScript from .NET in Blazor](https://learn.microsoft.com/en-us/aspnet/core/blazor/javascript-interoperability/call-javascript-from-dotnet) -- Official guide on JS interop from the .NET side.
- [Call .NET from JavaScript in Blazor](https://learn.microsoft.com/en-us/aspnet/core/blazor/javascript-interoperability/call-dotnet-from-javascript) -- How to set up callbacks from JS into C# components.
- [JavaScript isolation in Blazor](https://learn.microsoft.com/en-us/aspnet/core/blazor/javascript-interoperability/import-export-interop) -- Module-based interop patterns for avoiding global scope pollution.
