...
- [Kubernetes Cluster Setup for AI Workloads](/blog/kubernetes-cluster-setup-for-agentic-ai-workloads) — The cluster architecture this GitOps pipeline deploys into
- [Integrating Docling OCR in a .NET Document Pipeline](/blog/docling-ocr-dotnet-integration) — An example AI service deployed using this exact pattern
