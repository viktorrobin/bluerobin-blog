...
### Further Reading
- [Testcontainers for .NET getting started guide](https://testcontainers.com/guides/getting-started-with-testcontainers-for-dotnet/)
- [Microsoft: Integration tests in ASP.NET Core](https://learn.microsoft.com/en-us/aspnet/core/test/integration-tests)
- [xUnit.net shared context and fixtures](https://xunit.net/docs/shared-context)
- [FluentAssertions documentation](https://fluentassertions.com/)
- [Bogus fake data generator for .NET](https://github.com/bchavez/Bogus)
