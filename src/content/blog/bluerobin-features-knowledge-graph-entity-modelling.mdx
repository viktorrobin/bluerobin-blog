...
Ensemble NER handles the extraction. Canonical entities handle the deduplication. FalkorDB handles the graph storage. Entity types handle the taxonomy. Together, they create a structure that vector search alone cannot produce.
