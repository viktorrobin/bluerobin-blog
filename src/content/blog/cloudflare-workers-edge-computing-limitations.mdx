...
- [Cloudflare Workers Documentation](https://developers.cloudflare.com/workers/) -- Official reference for the Workers runtime, APIs, and configuration.
- [Designing Distributed Systems](https://www.oreilly.com/library/view/designing-distributed-systems/9781491983638/) -- Brendan Burns' patterns for modern distributed architectures.
- [The Edge Computing Landscape](https://www.infoq.com/articles/edge-computing-landscape/) -- A broader view of edge computing beyond Cloudflare.
