...
toc: true
deprecated: true
deprecatedReason: "Longhorn block storage is no longer used — BlueRobin runs on NAS-backed local PersistentVolumes over NFS."
---
...
<ExternalCite title="Longhorn Official Documentation" url="https://longhorn.io/docs/" author="SUSE / Longhorn" date="2024" />

<ExternalCite title="Kubernetes Storage Concepts" url="https://kubernetes.io/docs/concepts/storage/" author="Kubernetes Authors" date="2024" />

<ExternalCite title="ZFS on Linux Documentation" url="https://openzfs.github.io/openzfs-docs/" author="Openzfs" date="2024" />
<ExternalCite
/>
