...
tags: ["qdrant", "vector-database", "kubernetes", "semantic-search", "embeddings"]
readTime: "18 min"
toc: true
---
...
Qdrant is a high-performance vector database designed for similarity search. This guide covers deploying Qdrant on Kubernetes and integrating it with .NET applications for semantic document search.
...
flowchart TB
    ...
    style Cluster fill:#dc4a38,color:#fff
    style Nodes fill:#b73a2b,color:#fff
    style Storage fill:#8b2d22,color:#fff
```
