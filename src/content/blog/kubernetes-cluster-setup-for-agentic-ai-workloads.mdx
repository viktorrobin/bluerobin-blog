...
- [Shipping a New AI Service with GitOps](/blog/graphrag-gitops-kustomize-externalsecrets) — How to deploy a new service into this cluster using Kustomize overlays and ExternalSecrets
- [Integrating Docling OCR in a .NET Document Pipeline](/blog/docling-ocr-dotnet-integration) — Building the OCR service that runs in the `ai` namespace
