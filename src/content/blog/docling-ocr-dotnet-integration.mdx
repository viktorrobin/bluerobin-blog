...
- [Kubernetes Cluster Setup for AI Workloads](/articles/kubernetes-cluster-setup-for-agentic-ai-workloads) — The cluster architecture where this OCR service runs
- [Shipping a New AI Service with GitOps](/articles/graphrag-gitops-kustomize-externalsecrets) — How this service gets deployed via GitOps
