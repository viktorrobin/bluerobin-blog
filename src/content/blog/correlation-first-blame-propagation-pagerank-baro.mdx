...
**Classical and statistical RCA.** Spectrum-and-random-walk methods rank suspect services by propagating anomaly mass over a dependency graph. MicroRank (Yu et al., WWW'21; [doi:10.1145/3442381.3449905](https://dl.acm.org/doi/10.1145/3442381.3449905)) combines spectrum analysis with PageRank-style blame propagation; TraceRCA ([Li et al., IWQoS'21](https://ieeexplore.ieee.org/document/9521340/)) mines suspicious sets from anomalous traces and ranks by conditional probability. BARO (Pham et al., 2024; [arXiv:2405.09330](https://arxiv.org/abs/2405.09330)) detects the failure *onset* with multivariate BOCPD and then ranks with a nonparametric RobustScorer; it is parameter-free, training-free, and runs in roughly 0.01 s. Our pre-LLM layer sits squarely in this family: error-weighted personalized PageRank for propagation, plus a hand-rolled BARO core for onset and robust ranking.

**Causal RCA, and why we decline it.** A parallel line of work learns a causal graph and infers the root from it: CIRCA (Li et al., KDD'22; [arXiv:2206.05871](https://arxiv.org/abs/2206.05871)) frames a fault as an intervention and applies a regression-based hypothesis test; RCD ([Ikram et al., NeurIPS'22](https://openreview.net/forum?id=weoLjoYFvXY)) does localized causal discovery with a ψ-PC variant; RUN (Lin et al., AAAI'24; [arXiv:2402.01140](https://arxiv.org/abs/2402.01140)) combines neural Granger causality with personalized PageRank. The decisive evidence against adopting causal *discovery* in our setting comes from two independent re-evaluations. RCAEval (Pham et al., 2024; [arXiv:2412.17015](https://arxiv.org/abs/2412.17015)) re-runs 15 baselines across 735 cases and finds correlation methods (BARO Avg@5 0.80, TraceRCA 0.77) decisively beating causal ones (CIRCA 0.46, MicroCause 0.20, RCD 0.13). "Root Cause Analysis with LLMs... How Far Are We from Causal Inference?" (Zhang et al., ASE'24; [arXiv:2408.13729](https://arxiv.org/abs/2408.13729)) finds PC/FCI/Granger full-graph methods are "no better or only slightly better than random," require the *exact* failure time (a 60 s error degrades them significantly), and blow up computationally (PC+KCI exceeding an hour per case at ten nodes versus BARO's ~0.01 s). The defensible causal *idea* — "fault as intervention" — survives in our change-correlation term; the *graph-learning step* is the weak, expensive link we drop.

**Anomaly detection.** TSB-AD ([Liu & Paparrizos, VLDB'24](https://github.com/thedatumorg/TSB-AD)) benchmarks 40 algorithms over 1,070 series and concludes that "simpler architectures and statistical methods often yield better performance"; foundation models neither win nor pay for their 10–50× slowdown. This is the empirical warrant for a median-based, distribution-free robust scorer over a learned detector.

**Benchmarks.** OpenRCA ([arXiv, ICLR'25](https://github.com/microsoft/OpenRCA)), AIOpsLab (Chen et al., 2025; [arXiv:2501.06706](https://arxiv.org/abs/2501.06706)), ITBench ([arXiv:2502.05352](https://arxiv.org/abs/2502.05352)) and RCAEval ([arXiv:2412.17015](https://arxiv.org/abs/2412.17015)) supply the metric vocabulary (AC@k, Avg@k, MRR, MTTD/MTTR/TTM) we adopt internally. RCAEval's AC@k/Avg@k/MRR is the closest analogue to our own scorecard. A standing caveat ([arXiv:2510.04711](https://arxiv.org/abs/2510.04711)) warns that current RCA benchmarks are oversimplified and overstate real capability — a caveat we apply to our own nine-incident set in §7.
...
1. Pham, L., et al. [*BARO: Robust Root Cause Analysis with Bayesian Online Change-Point Detection.*](https://arxiv.org/abs/2405.09330) FSE 2024. arXiv:2405.09330.
2. Pham, L., et al. [*RCAEval: A Benchmark for Root Cause Analysis of Microservice Systems.*](https://arxiv.org/abs/2412.17015) WWW 2025. arXiv:2412.17015.
3. Zhang, et al. [*Root Cause Analysis with LLMs... How Far Are We from Causal Inference?*](https://arxiv.org/abs/2408.13729) ASE 2024. arXiv:2408.13729.
4. Li, M., et al. [*CIRCA: Causal Inference-based Root Cause Analysis (Regression-based Hypothesis Testing).*](https://arxiv.org/abs/2206.05871) KDD 2022. arXiv:2206.05871.
5. Ikram, A., et al. [*RCD: Root Cause Discovery via Localized Causal Discovery.*](https://openreview.net/forum?id=weoLjoYFvXY) NeurIPS 2022.
6. Lin, et al. [*RUN: Neural Granger Causality + Personalized PageRank for RCA.*](https://arxiv.org/abs/2402.01140) AAAI 2024. arXiv:2402.01140.
7. Yu, G., et al. [*MicroRank: End-to-End Latency Issue Localization with Spectrum + PageRank.*](https://dl.acm.org/doi/10.1145/3442381.3449905) WWW 2021.
8. Li, Z., et al. [*TraceRCA: Practical Root Cause Localization for Microservice Systems via Trace Analysis.*](https://ieeexplore.ieee.org/document/9521340/) IWQoS 2021.
9. Liu, Q., & Paparrizos, J. [*TSB-AD: The Elephant in the Room — Towards a Reliable Time-Series Anomaly Detection Benchmark.*](https://github.com/thedatumorg/TSB-AD) VLDB 2024.
10. Cemri, M., et al. [*Why Do Multi-Agent LLM Systems Fail? (MAST Failure Taxonomy).*](https://huggingface.co/blog/ibm-research/itbenchandmast) IBM + UC Berkeley, 2025.
11. Xu, J., et al. [*OpenRCA: Can Large Language Models Locate the Root Cause of Software Failures?*](https://github.com/microsoft/OpenRCA) ICLR 2025.
12. Chen, et al. [*AIOpsLab: A Holistic Framework for Evaluating AI Agents for Operations.*](https://arxiv.org/abs/2501.06706) 2025. arXiv:2501.06706.
13. IBM Research / Artificial Analysis. [*ITBench-AA: Agentic SRE Root-Cause Analysis Benchmark.*](https://huggingface.co/blog/ibm-research/itbench-aa) 2026.
14. [*Rethinking the Evaluation of Root Cause Analysis: A Fault-Propagation-Aware Benchmark.*](https://arxiv.org/abs/2510.04711) 2025. arXiv:2510.04711.
15. Beyer, B., et al. [*Site Reliability Engineering (Google SRE Book).*](https://sre.google/sre-book/introduction/) O'Reilly, 2016.
