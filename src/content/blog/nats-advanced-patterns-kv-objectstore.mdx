...
- [NATS Official Documentation](https://docs.nats.io/) -- Complete reference for JetStream, KV, and Object Store APIs.
- [Designing Data-Intensive Applications by Martin Kleppmann](https://dataintensive.net/) -- Essential reading on distributed data systems, consistency models, and stream processing.
- [NATS By Example](https://natsbyexample.com/) -- Community-driven collection of practical NATS patterns and code samples across multiple languages.
