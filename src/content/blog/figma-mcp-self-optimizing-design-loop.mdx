...
<ExternalCite title="Model Context Protocol Documentation" url="https://modelcontextprotocol.io/" author="Anthropic" date="2024" />

<ExternalCite title="Figma REST API Reference" url="https://www.figma.com/developers/api" author="Figma" date="2024" />

<ExternalCite title="Chrome DevTools Protocol" url="https://chromedevtools.github.io/devtools-protocol/" author="Chromedevtools" date="2024" />

<ExternalCite title="Visual Regression Testing Strategies" url="https://web.dev/articles/vitals-tools" author="Web" date="2024" />

<ExternalCite title="Tailwind CSS v4 Documentation" url="https://tailwindcss.com/docs" author="Tailwind Labs" date="2024" />
