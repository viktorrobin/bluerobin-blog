...
MinIO is retired (ADR-006): the `MinioHealthCheck` shown below has been replaced by an equivalent Cloudflare R2 reachability check. The check pattern is identical — swap the MinIO client for the S3-compatible R2 client.
</Callout>
...
<ExternalCite title="ASP.NET Core Health Checks Documentation" url="https://learn.microsoft.com/en-us/aspnet/core/host-and-deploy/health-checks" author="Microsoft" date="2024" />

<ExternalCite title="Kubernetes Probes Deep Dive" url="https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/" author="Kubernetes Authors" date="2024" />

<ExternalCite title="AspNetCore.Diagnostics.HealthChecks" url="https://github.com/Xabaril/AspNetCore.Diagnostics.HealthChecks" author="GitHub Community" date="2024" />
