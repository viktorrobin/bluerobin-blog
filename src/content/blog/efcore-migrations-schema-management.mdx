...
tags: ["efcore", "migrations", "postgresql", "schema", "database"]
readTime: "16 min"
toc: true
---
...
flowchart TB
    subgraph Lifecycle["🔄 Migration Lifecycle"]
        Change["📝 Entity Change\n(Code First)"] --> Add["➕ Add-Migration\ndotnet ef migrations add"]
        Add --> Review["👀 Review & Edit\nCheck generated SQL"]
        Review --> Commit["📤 Commit to Git\nVersion control"]
        Commit --> Update["🚀 Update-Database\ndotnet ef database update"]
    end

    style Lifecycle fill:#336791,color:#fff
```
