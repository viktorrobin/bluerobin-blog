...
- **[Agentic RRF: Ensembling for Production Search](/blog/agentic-rrf-ensembling-production-search)** -- the weight-tuning research behind the Reciprocal Rank Fusion scores.
- **[GraphRAG Hybrid Retrieval with FalkorDB and Qdrant](/blog/graphrag-hybrid-retrieval-falkordb-qdrant)** -- how vector and graph retrievers are combined at the API level.
- **[Hybrid Search: Semantic + Keyword](/blog/hybrid-search-semantic-keyword)** -- the fusion algorithm that powers multi-model search.
