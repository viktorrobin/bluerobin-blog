...
- [CSS backdrop-filter](https://developer.mozilla.org/en-US/docs/Web/CSS/backdrop-filter) -- MDN reference for the core CSS property powering glassmorphism.
- [WCAG 2.1 Contrast Guidelines](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum.html) -- Understanding minimum contrast ratios for accessible design.
