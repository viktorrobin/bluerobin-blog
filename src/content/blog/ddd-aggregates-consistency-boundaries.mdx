...
**Next Steps**:
- See how [Domain Events](/ddd-domain-events-csharp) let aggregates talk to each other.
- Learn about [Value Objects](/ddd-value-objects-csharp) which allow `DocumentTitle` to be more than just a string.
