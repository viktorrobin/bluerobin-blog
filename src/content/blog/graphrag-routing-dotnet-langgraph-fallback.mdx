...
- [Hybrid Retrieval with Graph Filters: FalkorDB + Qdrant](/blog/graphrag-hybrid-retrieval-falkordb-qdrant) — the graph traversal and vector search components that this router orchestrates
- [Agentic RRF Ensembling for Production Search](/blog/agentic-rrf-ensembling-production-search) — how the RRF ensemble works within the agentic retrieval path
