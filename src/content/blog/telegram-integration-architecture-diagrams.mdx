...
- [Telegram Bot API Documentation](https://core.telegram.org/bots/api) -- The official reference for all Bot API methods and update types
- [NATS by Example](https://natsbyexample.com/) -- Practical patterns for Core NATS and JetStream usage
...
- [Telegram Mini Apps Documentation](https://core.telegram.org/bots/webapps) -- Official reference for building Mini Apps with the WebApp SDK
- [FluxCD Documentation](https://fluxcd.io/docs/) -- GitOps toolkit used in our deployment architecture
