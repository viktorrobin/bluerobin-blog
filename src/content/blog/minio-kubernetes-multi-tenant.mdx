...
tags: ["minio", "s3", "object-storage", "kubernetes", "encryption"]
readTime: "20 min"
toc: true
---
...
flowchart TB
    ...
    style Cluster fill:#c72c48,color:#fff
    style KES fill:#1a1a2e,color:#fff
    style Nodes fill:#c72c48,color:#fff
    style Storage fill:#2d2d44,color:#fff
```
