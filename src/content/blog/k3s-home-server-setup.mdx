...
This guide walks you through setting up K3s on a home server, from initial installation to production-ready configuration.
...
- **[MetalLB Load Balancer for Bare Metal](/blog/metallb-load-balancer-bare-metal)** -- make services accessible from your LAN.
- **[Networking with Tailscale](/blog/networking-setup-tailscale-homelab)** -- secure remote access to your cluster.
- **[Homelab Dashboarding](/blog/homelab-dashboarding-homepage-backstage)** -- monitor your services with Homepage and Backstage.
...
<ExternalCite
  ...
  url="https://www.suse.com/products/k3s/"
  author="SUSE"
  date="2024"
/>

<ExternalCite
  title="The Home Lab Kubernetes Handbook"
  url="https://www.jeffgeerling.com/blog/2024/ive-mass-mass-migrated-my-home-lab-k3s"
