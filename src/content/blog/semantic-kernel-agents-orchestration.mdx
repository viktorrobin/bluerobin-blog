...
This article was upgraded on **2026-02-26** to reflect the latest agentic direction in BlueRobin, including safer orchestration patterns, GraphRAG integration boundaries, and practical routing/fallback behavior between agent pipelines.
...
Our agent system coordinates multiple specialized agents, each with access to specific tools:
