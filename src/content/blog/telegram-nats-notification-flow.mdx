...
- [NATS by Example](https://natsbyexample.com/) -- Practical patterns for Core NATS and JetStream with runnable examples
- [NATS.Net Client Documentation](https://github.com/nats-io/nats.net) -- The official .NET client library for NATS
- [Telegram Bot API - sendMessage](https://core.telegram.org/bots/api#sendmessage) -- Reference for the message-sending API used by the notification worker
- [OpenTelemetry .NET](https://opentelemetry.io/docs/languages/net/) -- Distributed tracing instrumentation for .NET services
- [Kustomize Documentation](https://kustomize.io/) -- Kubernetes-native configuration management used in the deployment setup
