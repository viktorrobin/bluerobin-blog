...
category: "ai"
difficulty: "expert"
tags: ["rag", "ollama", "qdrant", "llm", "ai", "semantic-search"]
readTime: "30 min"
toc: true
series:
...
flowchart TB
    ...
    style QueryProcessing fill:#f39c12,color:#fff
    style Retrieval fill:#9b59b6,color:#fff
    style Context fill:#27ae60,color:#fff
    style Generation fill:#e74c3c,color:#fff
    style Response fill:#1abc9c,color:#fff
```
