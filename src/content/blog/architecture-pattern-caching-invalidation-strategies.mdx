...
- [Redis documentation on caching patterns](https://redis.io/docs/latest/develop/use/) -- covers cache-aside, write-through, and write-behind strategies.
- [NATS by Example](https://natsbyexample.com/) -- hands-on examples for pub/sub, request-reply, and JetStream patterns.
- [Designing Data-Intensive Applications](https://dataintensive.net/) by Martin Kleppmann -- the definitive guide to understanding distributed system trade-offs including caching consistency.
- [Microsoft's distributed caching guidance](https://learn.microsoft.com/en-us/aspnet/core/performance/caching/distributed) -- official ASP.NET Core documentation for `IDistributedCache`.
