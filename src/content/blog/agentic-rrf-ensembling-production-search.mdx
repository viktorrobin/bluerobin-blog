...
- [Hybrid Retrieval with Graph Filters: FalkorDB + Qdrant](/blog/graphrag-hybrid-retrieval-falkordb-qdrant) — how graph traversal complements vector search in the ensemble
- [GraphRAG Routing with Fallback Strategies](/blog/graphrag-routing-dotnet-langgraph-fallback) — ensuring the agentic pipeline degrades gracefully when components fail
