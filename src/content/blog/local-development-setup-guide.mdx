...
<ExternalCite title="Infisical Documentation" url="https://infisical.com/docs/documentation/getting-started/introduction" author="Infisical" date="2024" />

<ExternalCite title="Tailscale Subnet Routers" url="https://tailscale.com/kb/1019/subnets" author="Tailscale" date="2024" />

<ExternalCite title=".NET CLI Tools Overview" url="https://learn.microsoft.com/en-us/dotnet/core/tools/" author="Microsoft" date="2024" />

<ExternalCite title="VS Code Compound Tasks" url="https://code.visualstudio.com/docs/editor/tasks#_compound-tasks" author="Code" date="2024" />
