...
toc: true
deprecated: true
deprecatedReason: "MinIO is retired — document storage moved to Cloudflare R2 with app-layer envelope encryption (ADR-006)."
---
...
<ExternalCite title="AWS S3 Developer Guide" url="https://docs.aws.amazon.com/AmazonS3/latest/dev/Welcome.html" author="Docs" date="2024" />

<ExternalCite title="Polly .NET Resilience Library" url="https://github.com/App-vNext/Polly" author="GitHub Community" date="2024" />
