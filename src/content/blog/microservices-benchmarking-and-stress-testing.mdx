...
- [NBomber Documentation and Examples](https://nbomber.com/docs/getting-started/overview/) -- Complete guide to writing load test scenarios in .NET.
- [The Art of Capacity Planning by John Allspaw](https://www.oreilly.com/library/view/the-art-of/9780596518578/) -- Classic text on understanding and planning for system capacity.
- [Brendan Gregg's USE Method](https://www.brendangregg.com/usemethod.html) -- Systematic methodology for analyzing system performance (Utilization, Saturation, Errors).
- [k6 Load Testing Documentation](https://grafana.com/docs/k6/latest/) -- Open-source load testing tool with excellent scripting support.
