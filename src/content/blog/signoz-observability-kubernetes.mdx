...
difficulty: "advanced"
tags: ["signoz", "observability", "opentelemetry", "tracing", "metrics", "logs"]
readTime: "22 min"
toc: true
type: "cookbook"
---
...
flowchart TB
    ...
    style Apps fill:#512bd4,color:#fff
    style Collector fill:#ff6b35,color:#fff
    style Backend fill:#00a699,color:#fff
```
