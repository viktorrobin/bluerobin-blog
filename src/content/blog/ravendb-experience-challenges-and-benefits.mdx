...
toc: true
deprecated: true
deprecatedReason: "RavenDB is no longer used — BlueRobin's database is PostgreSQL via the CloudNativePG operator."
---
...
<ExternalCite title="RavenDB Official Documentation" url="https://ravendb.net/docs" author="Hibernating Rhinos" date="2024" />

<ExternalCite title="Inside RavenDB Book" url="https://ravendb.net/learn/inside-ravendb-book/reader/4.0" author="Ayende Rahien" date="2024" />

<ExternalCite title="RavenDB Live Demo" url="https://demo.ravendb.net" author="Hibernating Rhinos" date="2024" />

<ExternalCite title="Document Modeling Best Practices" url="https://ravendb.net/docs/article-page/6.0/csharp/studio/database/documents/document-view" author="Hibernating Rhinos" date="2024" />
