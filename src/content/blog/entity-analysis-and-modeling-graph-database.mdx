...
- [Neo4j Graph Data Science Library](https://neo4j.com/docs/graph-data-science/current/) -- Comprehensive guide to graph algorithms and analytics.
- [Microsoft GraphRAG: A Modular Graph-Based RAG System](https://github.com/microsoft/graphrag) -- Open-source implementation of graph-enhanced retrieval augmented generation.
- [FalkorDB: The Fastest Graph Database](https://www.falkordb.com/) -- Official documentation and getting started guides.
- [Entity Resolution in Knowledge Graphs](https://dl.acm.org/doi/10.1145/3459637.3482488) -- Academic survey on deduplication and entity linking strategies.
