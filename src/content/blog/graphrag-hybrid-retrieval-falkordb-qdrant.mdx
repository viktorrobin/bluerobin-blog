...
- [Agentic RRF Ensembling for Production Search](/articles/agentic-rrf-ensembling-production-search) — how we weight and fuse multiple retrieval signals including graph results
- [GraphRAG Routing with Fallback Strategies](/articles/graphrag-routing-dotnet-langgraph-fallback) — what happens when the graph database goes down
