...
- [NATS Server Monitoring Documentation](https://docs.nats.io/running-a-nats-service/nats_admin/monitoring)
- [Prometheus NATS Exporter](https://github.com/nats-io/prometheus-nats-exporter)
- [Google SRE: Monitoring Distributed Systems](https://sre.google/sre-book/monitoring-distributed-systems/)
- [.NET Metrics and Instrumentation](https://learn.microsoft.com/en-us/dotnet/core/diagnostics/metrics-instrumentation)
