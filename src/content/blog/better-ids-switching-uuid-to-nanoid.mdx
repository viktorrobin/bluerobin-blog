...
<ExternalCite title="NanoID README and collision probability analysis" url="https://github.com/ai/nanoid" author="GitHub Community" date="2024" />

<ExternalCite title="IETF RFC 9562 on UUID formats including UUIDv7" url="https://www.rfc-editor.org/rfc/rfc9562" author="IETF" date="2024" />

<ExternalCite title="PostgreSQL documentation on index types and B-tree internals" url="https://www.postgresql.org/docs/current/btree.html" author="PostgreSQL Global Development Group" date="2024" />

<ExternalCite title="NanoID collision calculator for custom alphabet configurations" url="https://zelark.github.io/nano-id-cc/" author="Anton Yelizarov" date="2024" />
